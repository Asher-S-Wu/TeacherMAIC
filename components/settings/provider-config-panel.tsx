...
import { Loader2, CheckCircle2, XCircle, Zap, Sparkles, Wrench, FileText, Send } from 'lucide-react';
...
export function ProviderConfigPanel({ provider, providersConfig }: ProviderConfigPanelProps) {
  ...
  }, [provider.id, provider.requiresApiKey, providersConfig, t]);
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30 p-3 text-sm text-blue-700 dark:text-blue-300">
        {isServerConfigured ? t('settings.serverConfiguredNotice') : t('settings.serverConfigMissingNotice')}
      </div>
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          disabled={testStatus === 'testing' || !isServerConfigured}
          className="gap-1.5"
        >
          {testStatus === 'testing' ? (

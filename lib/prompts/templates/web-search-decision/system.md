...
- The request names a current company, product, public figure, event, regulation, dataset, website, paper, or report that is not sufficiently covered by the provided PDF excerpt
...
- The uploaded PDF excerpt already contains the needed source material and the user only asks to teach or summarize it
